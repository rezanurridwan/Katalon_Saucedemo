...
WebUI.setText(findTestObject('Product/firstname'), '')

WebUI.setText(findTestObject('Product/lastname'), '')

WebUI.setText(findTestObject('Product/postcal code'), '')
...
WebUI.verifyElementText(findTestObject('Product/assertion/h3_Error First Name is required'), 'Error: First Name is required')
